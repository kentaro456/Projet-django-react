...
function QuizAppMusic() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const shuffledQuestions = shuffleArray(data.musics);
  ...
  return (
    <div style={styles.container} id="c1">
      ...
      >
        <div className="flex items-center justify-center p-4">
          <audio
            ...
            src={currentQuestion.music}
          >
            Votre navigateur ne supporte pas l'élément audio.
          </audio>
          {audioError && <p style={{ color: "red" }}>Erreur de lecture audio.</p>}
          ...
          {!isPlaying ? (
            ...
            <button onClick={stopAudio} style={styles.audioButton}>
              Stop
            </button>
          )}

          <button onClick={handleMuteToggle} style={styles.audioButton}>
